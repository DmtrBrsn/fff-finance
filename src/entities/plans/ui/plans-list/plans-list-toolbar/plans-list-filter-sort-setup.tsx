...
import { PlansListSortControls } from "./plans-list-sort-controls"
import './plans-list-sort-filter.css'
import { FilterCondition } from '../../../../../shared/lib/utils'
import { ButtonGroup, SelectItem, ButtonIcon, Button, Popover, Select, NumberField, Checkbox, RadioGroup } from '../../../../../shared/ui'
        ...
        <Popover>
          <div className="flex-col gap-2">
            <div className="flex-row gap-1">
              <span>Date</span>
              <PlansListSortControls field="dateStart" />
            </div>
            <div className="flex-row gap-1">
              <span>Sum</span>
              <PlansListSortControls field="sum" />
              <SumFilter />
            </div>
            <div className="flex-col gap-1">
              <div className="flex-row gap-1">
                Description
                <PlansListSortControls field="description" />
              </div>
              <DescriptionFilter />
            </div>
            <div className="flex-col gap-1">
              <div className="flex-row gap-1">
                Category
                <PlansListSortControls field="category" />
              </div>
              <CategoryFilter />
            </div>
            <div className="flex-row gap-1">
              isIncome
              <PlansListSortControls field="isIncome" />
              <IsIncomeFilter />
            </div>
            <div className="flex-row gap-1">
              <span>Created</span>
              <PlansListSortControls field="created" />
            </div>
          </div>
        </Popover>
      </DialogTrigger>
